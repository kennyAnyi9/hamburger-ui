...
const menuNavigationLinks: NavigationLink[] = [
  { href: "/", text: "Homeward Bound", icon: "Home" },
  { href: "/", text: "Doc's Orders", icon: "Home" },
  { href: "/", text: "The Big Reveal", icon: "Home" },
  { href: "/", text: "We Got You Covered", icon: "Home" },
  { href: "/", text: "Fresh News & Brews ", icon: "Home" },
  { href: "/", text: "Let's Chat! ", icon: "Home" },
  { href: "/", text: "Showtime! ", icon: "Home" },
  { href: "/", text: "Meet the Masterminds", icon: "Home" },
  // ... other links
];
