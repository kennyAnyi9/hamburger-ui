  ...
  return (
    <main className="overflow-hidden flex min-h-screen flex-col items-center justify-between px-5 gap-20  md:px-24  pt-24">
      <section className="h-fit max-w-5xl flex flex-col items-center gap-5 ">
        ...
        <h1 className="font-semibold text-opacity-50 text-4xl text-center md:text-8xl text-transparent bg-clip-text bg-gradient-to-t from-gray-950 to-gray-200">
          Humburger UI
        </h1>
        ...
        >
          <Button className="button_class_default inline-flex gap-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
      ...
      <section className="w-screen">
        <div className="overflow-hidden mx-auto w-4/5 border bg-white dark:bg-transparent rounded-[--card-border-radius] border-[--ui-light-border-color] dark:border-[--ui-dark-border-color]">
          ...
          <div>
            <Skeleton className="w-[700px] h-[500px]">
              some random place holder to be replaced with high quality
